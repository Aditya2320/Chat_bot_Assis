...
def check_all_messages(message):
    ...
    # Responses -------------------------------------------------------------------------------------------------------
    response(random.choice(['Hello !! This is Your Assistant ','Hey !! I am Assis ','Hiii !! This is Assis ','Hey Buddy!!! I am Assis.']), ['hello', 'hi','hii', 'hey', 'sup', 'heyo'], single_response=True)
...
print("Hey There !!! This is your Virtual assistant !!")
while True:
    user=input('You: ')
